...
```mermaid
journey
  title User Journey: Покупка билетов в кино
  section Поиск фильма (4.7/5)
    Просмотр афишы: 5
    Фильтрация по жанру: 4
    Чтение отзывов: 5
  section Выбор сеанса (3.7/5)
    Выбор даты: 4
    Выбор времени: 3
    Выбор формата: 4
  section Выбор мест (3.0/5)
    Выбор сектора: 4
    Бронирование мест: 3
    Изменение выбора: 2
  section Оплата (3.3/5)
    Выбор способа оплаты: 4
    Ввод промокода: 3
    Подтверждение: 3
  section Получение (4.7/5)
    Электронный билет: 5
    QR-код: 5
    Напоминание: 4
  section Оценка (4.3/5)
    Удовлетворенность: 4
    Рекомендация: 5
    Повторное посещение: 4
```
